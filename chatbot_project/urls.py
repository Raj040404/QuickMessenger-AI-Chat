...
from chatbot.views import send_message  # Import the forwarded_messages view
...
urlpatterns = [
    ...
    path('send_message/', send_message, name='send_message'),    # Add the forwarded_messages path here
]
